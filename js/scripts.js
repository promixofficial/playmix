...
/***/ function(module, exports) {
	...
	angular.module("playMixApp").factory('localStorageFct', [function () {
...
/***/ function(module, exports) {
	...
	angular.module("playMixApp").factory('storageFct', ['$localForage', function ($localForage) {
	    /**
...
/***/ function(module, exports) {
	...
	angular.module("playMixApp").factory('listFct', ['storageFct', 'localStorageFct', function (storageFct, localStorageFct) {
	  /**
	  * @namespace listFct 
	  */
	  var List = {
	    ...
	    get lastSelectedListIndex() {
	      var lastIndex = localStorageFct.getItem('lastSelectedListIndex') || 0;
	    ...
	    removeList: function removeList(list) {
	      ...
	      storageFct.removeItem('_playlist_' + list.id).then(function () {
	        _this.onChangeList();
	      });
	    },
	    ...
	    setLastSelectedListIndex: function setLastSelectedListIndex() {
	      ...
	      localStorageFct.setItem('lastSelectedListIndex', lastIndex !== -1 ? lastIndex : 0);
	    },
...
/***/ function(module, exports) {
	...
	angular.module("playMixApp").factory('playlistFct', ['$rootScope', '$timeout', 'YT_event', 'utilsFct', 'storageFct', 'localStorageFct', function ($rootScope, $timeout, YT_event, utilsFct, storageFct, localStorageFct) {
	  /**
	  ...
	  */
	  var Playlist = {
	    ...
	    getPlaylist: function getPlaylist() {
	      return storageFct.getItem('playlist').then(function (playlist) {
	        return playlist || [];
	      });
	    },
...
/***/ function(module, exports) {
	...
	angular.module("playMixApp").controller('mainCtrl', ['$scope', '$rootScope', '$timeout', '$mdSidenav', '$log', 'YT_event', 'listFct', 'playlistFct', 'searchFct', '$localForage', 'fileFct', '$mdDialog', function ($scope, $rootScope, $timeout, $mdSidenav, $log, YT_event, listFct, playlistFct, searchFct, $localForage, fileFct, $mdDialog) {
	  ...
	  $scope.Playlist.getPlaylist().then(function (playlist) {
